  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(resp.ok) {
        ...
        setApplicationRef(result.reference_number);
        setIsSuccess(true);
      }
    } catch(err) {
      console.error(err);
      ...
      <div className="pub-page animate-fade-in">
        ...
        <div className="public-form-container" style={{textAlign: 'center', marginTop: '40px'}}>
          ...
          <div style={{marginTop: '40px', display: 'flex', justifyContent: 'center', gap: '16px'}}>
            <a href={`${API_BASE_URL}/api/visa/pre-approval/${applicationRef}`} className="public-btn primary" target="_blank" rel="_noreferrer">Download Receipt</a>
